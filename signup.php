...
$sql="insert into administrator(system_id,fname,lname,email,username,password,collage_code,mobile) values('','$f','$l','$e','$u','$p','$c','$m')";
$result=mysqli_query($conn,$sql);
if($result)
{
	echo "insert is succssfully";
	
	
}
else
{
	echo "mysql problam:".mysqli_error();
...
#page{
width:150px;height:50px;background-color:blue;padding:2px;margin-left:50px;color:white; text-align:center;}
</style>
<body>

<h2>Modal Signup Form</h2>
<button onclick="document.getElementById('id01').style.display='block'" style="width:auto;">Sign Up</button><br><br>
            <div id="page">  <a href="Mainpage.php" style="padding:2px;color:white;">Go to login page</a></div>
  ...
  <form  method="post"   class="modal-content">
    <div class="container">
      ...
      <input type="text" placeholder="Enter Last Name" name="lname" required>
	   <label for="email"><b>Collage code</b></label>
      <input type="text" placeholder="Enter Collage Code" name="code" required>
