...
if(isset($_GET['question'])){
	...
	if($arrCount >= $numQuestions){
		echo 'finished|<p>There are no more questions. Please enter your first and last name and click next</p>
				<form action="puserAnswer.php" method="post">
				<input type="hidden" name="complete" value="true">
				<h1>Enter username</h1>
				<input type="text" name="username">
				<h1>Enter Email Address</h1>
				<input type="text" name="email"><br/><br/><br/>
				<input type="submit" value="Finish" width="200" height="50">
				</form><br/><br/>
	...
	$singleSQL = mysqli_query($conn,"SELECT * FROM pquestions WHERE id='$question'");
		while($row = mysqli_fetch_array($singleSQL)){
			...
			$sql2 = mysqli_query($conn,"SELECT * FROM panswers WHERE question_id='$question' ORDER BY rand()");
