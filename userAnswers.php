...
$response = ""; 
	...
	exit();
		...
		$countCheck = mysqli_query($conn,"SELECT id FROM questions")or die(mysqli_error());
	...
	if(!in_array("1", $_SESSION['answer_array'])){
		$sql = mysqli_query($conn,"INSERT INTO quiz_takers (username, percentage, date_time) 
		VALUES ('$username', '0', now())")or die(mysqli_error());
