...
if(isset($_POST['desc'])){
	...
	$sql = mysqli_query($conn,"INSERT INTO questions (question, type) VALUES ('$question', '$type')")or die(mysqli_error());
	...
	if($type == 'tf'){
		...
		$sql2 = mysqli_query($conn,"INSERT INTO answers (question_id, answer, correct) VALUES ('$lastId', '$answer1', '1')")or die(mysqli_error());
		mysqli_query($conn,"INSERT INTO answers (question_id, answer, correct) VALUES ('$lastId', '$answer2', '0')")or die(mysqli_error());
		$msg = 'Thanks, your question has been added';
	  header('location: addQuestions.php?msg='.$msg.'');
	exit();
	}
	if($isCorrect == "answer2"){
		$sql2 = mysqli_query($conn,"INSERT INTO answers (question_id, answer, correct) VALUES ('$lastId', '$answer2', '1')")or die(mysqli_error());
		mysqli_query($conn,"INSERT INTO answers (question_id, answer, correct) VALUES ('$lastId', '$answer1', '0')")or die(mysqli_error());
		$msg = 'Thanks, your question has been added';
	  header('location: addQuestions.php?msg='.$msg.'');
	exit();
		}	
	...
	if($type == 'mc'){
		...
		$sql2 = mysqli_query($conn,"INSERT INTO answers (question_id, answer, correct) VALUES ('$lastId', '$answer1', '1')")or die(mysqli_error());
		mysqli_query($conn,"INSERT INTO answers (question_id, answer, correct) VALUES ('$lastId', '$answer2', '0')")or die(mysqli_error());
		mysqli_query($conn,"INSERT INTO answers (question_id, answer, correct) VALUES ('$lastId', '$answer3', '0')")or die(mysqli_error());
		mysqli_query($conn,"INSERT INTO answers (question_id, answer, correct) VALUES ('$lastId', '$answer4', '0')")or die(mysqli_error());
		$msg = 'Thanks, your question has been added';
	  header('location: addQuestions.php?msg='.$msg.'');
	exit();
	}
	...
	if($isCorrect == "answer3"){
		$sql2 = mysqli_query($conn,"INSERT INTO answers (question_id, answer, correct) VALUES ('$lastId', '$answer3', '1')")or die(mysqli_error());
		mysqli_query($conn,"INSERT INTO answers (question_id, answer, correct) VALUES ('$lastId', '$answer1', '0')")or die(mysqli_error());
		mysqli_query($conn,"INSERT INTO answers (question_id, answer, correct) VALUES ('$lastId', '$answer2', '0')")or die(mysqli_error());
		mysqli_query($conn,"INSERT INTO answers (question_id, answer, correct) VALUES ('$lastId', '$answer4', '0')")or die(mysqli_error());
		$msg = 'Thanks, your question has been added';
	...
	if($isCorrect == "answer4"){
		$sql2 = mysqli_query($conn,"INSERT INTO answers (question_id, answer, correct) VALUES ('$lastId', '$answer4', '1')")or die(mysqli_error());
		mysqli_query($conn,"INSERT INTO answers (question_id, answer, correct) VALUES ('$lastId', '$answer1', '0')")or die(mysqli_error());
		mysqli_query($conn,"INSERT INTO answers (question_id, answer, correct) VALUES ('$lastId', '$answer2', '0')")or die(mysqli_error());
		mysqli_query($conn,"INSERT INTO answers (question_id, answer, correct) VALUES ('$lastId', '$answer3', '0')")or die(mysqli_error());
		$msg = 'Thanks, your question has been added';
