...
<div class="card" style="width: 20rem;">
  <img class="card-img-top" src="user.png" width="150" height="150" alt="Card image cap">
  <div class="card-body">
    <p class="card-text" style=" border:1px solid black; padding-bottom:8px;">All Student recoard </p>
  </div>
...
<div class="card" style="width: 18rem;">
 <a href="      "> <img class="card-img-top" src="quiz.jpg"  width="150" height="150"  alt="Card image cap"></a>
  <div class="card-body">
    <p class="card-text" style="border:1px solid black; padding-bottom:8px;"> All Subjects  </p>
  </div>
</div> </div>
<div id="r">
<div class="card" style="width: 18rem;">
<a href="index.php">  <img class="card-img-top" src="q&a.jpg"  width="150" height="150" alt="Card image cap"></a>
    <p class="card-text" style=" border:1px solid black; padding-bottom:8px;">Aptitude  Test  </p>
  <div class="card-body">
  </div>
</div> </div>
...
<div id="r">
<div class="card" style="width: 18rem;">
   <a href="pindex.php"> <img class="card-img-top" src="data1.jpg" width="150" height="150"  alt="Card image cap"></a>
  <div class="card-body">
  <p class="card-text" style=" border:1px solid black; padding-bottom:8px;">Programming Test  </p>
  </div>
</div> </div>
<div id="r">
<div class="card" style="width: 18rem;">
  ...
  <div class="card-body">
    <p class="card-text" style=" border:1px solid black; padding-bottom:8px;" > Placement and Interview Questions    </p>
  </div>
</div> </div>
<br/>
<br/>
...
<div class="card" style="width: 18rem;">
 <a href="userAnswers.php"> <img class="card-img-top" src="result.jpg" width="150" height="150" alt="Card image cap">
  <div class="card-body">
    <p class="card-text" style=" border:1px solid black; padding-bottom:8px;"> All quiz test with timer </p></a>
  </div>
</div> </div>
<div id="r">
<div class="card" style="width: 18rem;">
  <img class="card-img-top" src="sub.jpg"  width="150" height="150" alt="Card image cap">
  <div class="card-body">
    <p class="card-text" style=" border:1px solid black; padding-bottom:8px;">Machine Learning and Big Data Science Course</p>
  </div>
</div> </div>
<div id="r">
<div class="card" style="width: 18rem;">
  ...
  <div class="card-body">
    <p class="card-text" style=" border:1px solid black; padding-bottom:8px;">Paractices Test </p>
  </div>
</div> </div>
